...
public class ContactController
{
   ...
   public String listContacts(@ModelAttribute("searchCriteria") ContactSearchCriteriaDTO contactSearchCriteria, Model model)
  {
    ...
    if (contactSearchCriteria.getFirstName() == Constants.EMPTY_STRING &&
            contactSearchCriteria.getLastName() == Constants.EMPTY_STRING  &&
            contactSearchCriteria.getOrganisationName() == Constants.EMPTY_STRING ) {
    ...
    model.addAttribute("invalidSearch", false);
